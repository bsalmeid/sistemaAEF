...
public class FrmCadTipoDocumento extends javax.swing.JInternalFrame {
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        ...
        if (cadastrar == JOptionPane.YES_OPTION) {
            AnoSafraB = new AnoSafra();
            popular(AnoSafraB);
            if (verificar(AnoSafraB) && ValidarPermissoes.validarPermissaoInsert(FrmCadTipoDocumento.class.getSimpleName())) {
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (editar == JOptionPane.YES_OPTION) {
            popular(AnoSafraB);
            if (verificar(AnoSafraB) && ValidarPermissoes.validarPermissaoUpdate(FrmCadTipoDocumento.class.getSimpleName())) {
