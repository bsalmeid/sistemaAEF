...
public class FrmCadPlanoContas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanelAnoSafra, javax.swing.GroupLayout.PREFERRED_SIZE, 599, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanelAnoSafra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        setBounds(0, 0, 635, 127);
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        ...
        if (cadastrar == JOptionPane.YES_OPTION) {
            AnoSafraB = new AnoSafra();
            popular(AnoSafraB);
            if (verificar(AnoSafraB) && ValidarPermissoes.validarPermissaoInsert(FrmCadPlanoContas.class.getSimpleName())) {
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (editar == JOptionPane.YES_OPTION) {
            popular(AnoSafraB);
            if (verificar(AnoSafraB) && ValidarPermissoes.validarPermissaoUpdate(FrmCadPlanoContas.class.getSimpleName())) {
