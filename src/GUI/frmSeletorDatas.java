...
public class frmSeletorDatas extends javax.swing.JDialog {

    public Date dataInicial;
    public Date dataFinal;
   
    public frmSeletorDatas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSeletorDatas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmSeletorDatas dialog = new frmSeletorDatas(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JButton btn_gerar;
    ...
    public void selecionarData(){
        dataInicial = txt_dtInicial.getDate();
        dataFinal = txt_dtFinal.getDate();
    }
