...
public class TableModelConsultaModeloInv extends AbstractTableModel {

    private List<ModeloEquipamentosBeans> ListPrincipal = new ArrayList<>();

    private final String[] colunas = {"Id","Categoria","Marca", "Modelo", "Largura", "Status"};

    public final int ID_MODELO = 0;
    public final int CATEGORIA = 1;
    public final int MARCA = 2;
    public final int MODELO = 3;
    public final int LARGURA = 4;
    public final int STATUS = 5;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case ID_MODELO:
                return beans.getID();
            case CATEGORIA:
                return beans.getId_categoria();
            case MARCA:
                return beans.getId_marca();
            case MODELO:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case ID_MODELO:
                ...
                break;
            case CATEGORIA:
                   beans.setId_categoria(((CategoriaEquipamentosBeans) aValue));
            break;
            case MARCA:
                  beans.setId_marca(((MarcaEquipamentosBeans) aValue));
            break;
            case MODELO:
