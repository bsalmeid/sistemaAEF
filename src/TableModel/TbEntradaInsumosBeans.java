 ...
 * @author Bruno
 */
public class TbEntradaInsumosBeans {
    
    int id;
    int idPedido;
    int ItemListaPedidos;
    String nPedido;
    int idInsumo;
    String Insumo;
    String Unidade;
    ...
    public int getItemListaPedidos() {
        return ItemListaPedidos;
    }

    public void setItemListaPedidos(int ItemListaPedidos) {
        this.ItemListaPedidos = ItemListaPedidos;
    }
